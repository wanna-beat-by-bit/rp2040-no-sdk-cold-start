...
#define CLOCKS_CLK_SYS_CTRL_CLKSRC_PLL_SYS 0x0u
#define CLOCKS_CLK_SYS_CTRL_SRC_MASK 0x1u
#define CLOCKS_CLK_SYS_CTRL_CLKSRC_CLK_SYS_AUX 0x1u
#define CLOCKS_CLK_SYS_SELECTED 0x44u
...
#define CLOCKS_FC0_SRC_MASK 0xffu
...
#define CLOCKS_CLK_PERI_CTRL 0x48u
#define CLOCKS_CLK_PERI_CTRL_ENABLE_BIT 11u
#define CLOCKS_CLK_PERI_CTRL_XOSC_CLKSRC 0x4u
...
#define PLL_CS 0x0u
#define PLL_CS_LOCK_BIT 31u
#define PLL_CS_REFDIV_LSB 0u
#define PLL_CS_REFDIV_MASK 0x3fu
#define PLL_PWR 0x4u
#define PLL_PWR_PD_BIT 0u
#define PLL_PWR_POSTDIVPD_BIT 3u
#define PLL_PWR_VCOPD_BIT 5u
#define PLL_FBDIV_INT 0x8u
#define PLL_FBDIV_INT_MASK 0xfffu
...
/* 12 MHz / 1 * 125 = 1500 MHz VCO (legal range 750-1600), / 6 / 2 = 125 MHz */
#define PLL_SYS_REFDIV 1u
#define PLL_SYS_FBDIV 125u
#define PLL_SYS_POSTDIV1 6u
#define PLL_SYS_POSTDIV2 2u

#define CLK_SYS_KHZ 125000u
#define CLK_SYS_KHZ_TOLERANCE 500u
